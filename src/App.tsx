...
import { Timer, History, Library, Settings, Box, ArrowUpRight, Moon, Sun, Sparkles } from 'lucide-react';
...
type Area = 'timer' | 'history' | 'algorithms' | 'settings';
const navigation = [{id:'timer',label:'Timer',icon:Timer},{id:'history',label:'Histórico',icon:History},{id:'algorithms',label:'Algoritmos',icon:Library},{id:'settings',label:'Configurações',icon:Settings}] as const;
