...
const navigation = [{id:'timer',label:'Timer',icon:Timer},{id:'history',label:'Histórico',icon:History},{id:'algorithms',label:'Algoritmos',icon:Library},{id:'trainers',label:'Treinadores',icon:Dumbbell},{id:'solver',label:'Solucionar',icon:WandSparkles},{id:'settings',label:'Configurações',icon:Settings}] as const;
